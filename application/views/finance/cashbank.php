                                ...
                                <table id="table_id" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($cashbank as $row) { ?>
                                            <tr>
                                                ...
                                                <td><?php if ($row->tipe == "M1") { ?>
                                                        Pemasukan

                                                    <?php } else { ?>Pengeluaran <?php }; ?></td>

                                                <td><?php echo $row->keperluan; ?></td>
                                                <td><?php echo $row->tanggal; ?></td>
                                                <td>Rp. <?php echo number_format($row->kredit, 2); ?></td>
                                                <td>Rp. <?php echo number_format($row->debit, 2); ?></td>
                                                <?php $a = $a + $row->kredit; ?>
                                                <?php $b = $b + $row->debit; ?>
                                    ...
                                    ?>
                                        ...
                                        <td> Pengeluaran </td>
                                            <td> Gaji Bulanan </td>
                                            <td> Bulanan </td>
                                            <td>Rp. <?php echo number_format($tgaji, 2); ?></td>
                                            <td>Rp. <?php echo number_format(0, 2); ?></td>
                                            <?php $a = $a + $tgaji; ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>Rp. <?php echo number_format($b, 2); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
