              ...
              <div class="container">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="<?= base_url() ?>MenuDivisi/absensi">Absensi</a></div>
                    </div>
                </div>
                  ...
                  <table id="table_id" class="table table-striped table-bordered " >
                    ...
                    <?php foreach ($pegawai as $peg) : ?>
                        <tr>
                            ...
                            <td><?= $peg['genderpegawai'];  ?></td>
                            <td><?= $peg['emailpegawai'];  ?></td>
                            <td><?= $peg['statuspegawai'];  ?></td>
                            <td><?= $peg['gajipegawai'];  ?></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
